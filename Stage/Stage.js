...
export default class Stage extends StageBase {
  constructor(...args) {
    ...
    this.vars.n = 571132801.3898568;
    this.vars.t = 1857.0999999994065;
    this.vars.nShow = "n(1857) = 571132801";
    this.vars.reqalphapow = 11332490.728954766;
    this.vars.alphapower = 19;
    this.vars.reqalphapowermul = 1.55;
    this.vars.goals2 = 6;
    this.vars.aloveLevel = 4;
    this.vars.aloveReq = 1920000000;
    this.vars.score = 4.378368551675392;
    this.vars.scorecom = 0;
    this.vars.scoreShow = "Score:4 / 0";
    this.vars.betapower = 1;
    this.vars.reqbetapow = 5;
  ...
  *whenGreenFlagClicked3() {
    while (true) {
      ...
      if (this.vars.alphapower > 4) {
        this.vars.n +=
          this.vars.t * Math.E ** this.vars.betapower * this.vars.alphapower;
      } else {
